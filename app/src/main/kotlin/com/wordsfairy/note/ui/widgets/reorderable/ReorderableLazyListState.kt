 ...
 */
package com.wordsfairy.note.ui.widgets.reorderable
...
import androidx.compose.ui.unit.dp
import com.wordsfairy.note.ui.widgets.reorderable.ReorderableState
...
fun rememberReorderableLazyListState(
    ...
    val state = remember(listState) {
        ReorderableLazyListState(listState, scope, maxScroll, onMove, canDragOver, onDragEnd, dragCancelledAnimation,onDragStart)
    }
...
class ReorderableLazyListState(
    ...
    public override suspend fun scrollToItem(index: Int, offset: Int) {
